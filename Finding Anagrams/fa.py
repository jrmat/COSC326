...
# Reduces dictionary down to words that are able to make an anagram of
# the input word and are not anagrams of a higher priority word in list
...
# Recursively checks for anagrams in dictionary
